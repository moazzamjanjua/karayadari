...
<body id="contact" class="all-hostels">
    ...
    <style>
        .hostel-image-container {
            ...
            margin-right: 20px;
            position: relative;
            /* Relative positioning for the ribbon */
            flex-shrink: 0;
        }
                            ...
                            <a href="{{ route('hostel-detail.show', $hostel->slug) }}" class="hostel-link">
                                <div class="row row-fixed hostel-card">
                                    ...
                                    <div class="hostel-details">
                                        <h5 style="color:red">{{ $hostel->hostel_name }}</h5>
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination">
                                    <li class="page-item{{ $hostels->onFirstPage() ? ' disabled' : '' }}">
                                        <a class="page-link"
                                            href="{{ $hostels->appends(request()->query())->previousPageUrl() }}"
                                            aria-label="Previous">
                                    ...
                                    <li class="page-item{{ !$hostels->hasMorePages() ? ' disabled' : '' }}">
                                        <a class="page-link"
                                            href="{{ $hostels->appends(request()->query())->nextPageUrl() }}"
                                            aria-label="Next">
