        ...
        <div class="section banner" style="position: relative; width: 100%; height: 100vh; overflow: hidden;">
            ...
            <div class="tiva-slideshow-wrapper" style="width: 100%; height: 100%;">
                <div id="tiva-slideshow" class="nivoSlider" style="width: 100%; height: 100%;">
                    <a href="#">
                        <img class="img-responsive" src="/frontend/img/home/home1-banner1.jpg" title="#caption1" alt="Slideshow image" style="width: 100%; height: 100%; object-fit: cover;">
                    </a>
                    <a href="#">
                        <img class="img-responsive" src="/frontend/img/home/home1-banner2.jpg" title="#caption2" alt="Slideshow image" style="width: 100%; height: 100%; object-fit: cover;">
                    </a>
                    <a href="#">
                        <img class="img-responsive" src="/frontend/img/home/home1-banner3.jpg" title="#caption3" alt="Slideshow image" style="width: 100%; height: 100%; object-fit: cover;">
                    </a>
                </div>
            </div>
