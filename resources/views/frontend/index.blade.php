        ...
        <div class="wrap-banner">
            ...
            <div class="section banner" style="position: relative; width: 100%; height: 100vh; overflow: hidden;">
                ...
                <div class="navbar" id="navbar-section"
                    style="position: absolute; bottom: -100px; width: 90%; max-width: 1200px; left: 60px; padding: 10px; background-color: rgba(0, 0, 0, 0.5); border-radius: 10px; display: flex; justify-content: space-around; align-items: center; z-index: 1000; opacity: 0; transition: opacity 1s ease-in-out, bottom 1s ease-in-out;">
