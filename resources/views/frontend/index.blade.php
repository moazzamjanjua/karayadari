...
<body id="home">
    ...
    .navbar {
        position: absolute;
        bottom: -100px; /* Start position, hidden below the view */
        width: 90%;
        height: 20%;
        max-width: 1200px;
        left: 60px;
        ...
        transition: opacity 1s ease-in-out, bottom 1s ease-in-out; /* 3 seconds for both */
    }
</style>
        ...
        <div class="wrap-banner">
            ...
            <div class="section banner" style="position: relative; width: 100%; height: 100vh; overflow: hidden;">
                ...
                <div class="welcome-text" id="welcome-text"
                     style="position: absolute; top: 40%; left: 37%; transform: translate(-50%, -50%) scale(1.5); color: white; font-size: 22px; z-index: 1000; opacity: 0; transition: transform 1s ease-in-out, opacity 1s ease-in-out;">
    ...
    window.addEventListener('load', function () {
        ...
        // Animate the navbar and welcome text
        setTimeout(() => {
